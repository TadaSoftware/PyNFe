...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_cst20_test(self):
        ...
        # Impostos
        # ICMS
        orig = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS20/ns:orig', namespaces=self.ns)[0].text
        CST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS20/ns:CST', namespaces=self.ns)[0].text
        modBC = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS20/ns:modBC', namespaces=self.ns)[0].text
        vBC = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS20/ns:vBC', namespaces=self.ns)[0].text
        pICMS = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS20/ns:pICMS', namespaces=self.ns)[0].text
        vICMS = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS20/ns:vICMS', namespaces=self.ns)[0].text
        pFCP = None
        vFCP = None
