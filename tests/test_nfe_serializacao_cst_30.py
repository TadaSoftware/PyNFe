...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_cst30_test(self):
        ...
        # Impostos
        # ICMS
        orig = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:orig', namespaces=self.ns)[0].text
        CST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:CST', namespaces=self.ns)[0].text
        modBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:modBCST', namespaces=self.ns)[0].text
        pMVAST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:pMVAST', namespaces=self.ns)[0].text
        pRedBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:pRedBCST', namespaces=self.ns)[0].text
        vBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:vBCST', namespaces=self.ns)[0].text
        pICMSST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:pICMSST', namespaces=self.ns)[0].text
        vICMSST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMS30/ns:vICMSST', namespaces=self.ns)[0].text
        pFCP = None
        vFCP = None
