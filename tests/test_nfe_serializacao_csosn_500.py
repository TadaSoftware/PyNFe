...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_csosn500_test(self):
        ...
        # Impostos
        # ICMS
        orig = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN500/ns:orig', namespaces=self.ns)[0].text
        CSOSN = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN500/ns:CSOSN', namespaces=self.ns)[0].text
