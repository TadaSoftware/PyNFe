...
class SerializacaoMDFeTestCase(unittest.TestCase):
    ...
    def grupo_municipio_carregamento(self):
        ...
        cMunCarrega_2 = self.xml_assinado.xpath('//ns:ide/ns:infMunCarrega/ns:cMunCarrega', namespaces=self.ns)[1].text
        xMunCarrega_2 = self.xml_assinado.xpath('//ns:ide/ns:infMunCarrega/ns:xMunCarrega', namespaces=self.ns)[1].text
    ...
    def grupo_percurso(self):
        ...
        UFPer_2 = self.xml_assinado.xpath('//ns:ide/ns:infPercurso/ns:UFPer', namespaces=self.ns)[1].text
    ...
    def grupo_emitente(self):
        ...
        xBairro = self.xml_assinado.xpath('//ns:emit/ns:enderEmit/ns:xBairro', namespaces=self.ns)[0].text
    ...
    def grupo_ciot(self):
        CIOT = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:infANTT/ns:infCIOT/ns:CIOT', namespaces=self.ns)[0].text
        CPF = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:infANTT/ns:infCIOT/ns:CPF', namespaces=self.ns)[0].text

        self.assertEqual(CIOT, '123456789012')
        self.assertEqual(CPF, '75961547191')

    def grupo_pedagio(self):
        CNPJForn = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:infANTT/ns:valePed/ns:disp/ns:CNPJForn', namespaces=self.ns)[0].text
        CPFPg = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:infANTT/ns:valePed/ns:disp/ns:CPFPg', namespaces=self.ns)[0].text
    ...
    def grupo_veiculos_reboque(self):
        ...
        placa = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicReboque/ns:placa', namespaces=self.ns)[1].text
        RENAVAM = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicReboque/ns:RENAVAM', namespaces=self.ns)[1].text
        tara = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicReboque/ns:tara', namespaces=self.ns)[1].text
        capKG = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicReboque/ns:capKG', namespaces=self.ns)[1].text
        capM3 = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicReboque/ns:capM3', namespaces=self.ns)[1].text
        tpCar = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicReboque/ns:tpCar', namespaces=self.ns)[1].text
        UF = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicReboque/ns:UF', namespaces=self.ns)[1].text
    ...
    def grupo_veiculo_tracao(self):
        cInt = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:cInt', namespaces=self.ns)[0].text
        placa = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:placa', namespaces=self.ns)[0].text
        RENAVAM = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:RENAVAM', namespaces=self.ns)[0].text
        tara = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:tara', namespaces=self.ns)[0].text
        capKG = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:capKG', namespaces=self.ns)[0].text
        capM3 = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:capM3', namespaces=self.ns)[0].text

        xNome_0 = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:condutor/ns:xNome', namespaces=self.ns)[0].text
        CPF_0 = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:condutor/ns:CPF', namespaces=self.ns)[0].text
        xNome_1 = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:condutor/ns:xNome', namespaces=self.ns)[1].text
        CPF_1 = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:condutor/ns:CPF', namespaces=self.ns)[1].text

        tpRod = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:tpRod', namespaces=self.ns)[0].text
        tpCar = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:tpCar', namespaces=self.ns)[0].text
        UF = self.xml_assinado.xpath('//ns:infModal/ns:rodo/ns:veicTracao/ns:UF', namespaces=self.ns)[0].text
    ...
    def grupo_informacoes_documentos_nfe_vinculados(self):
        ...
        """
        cMunDescarga_0 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:cMunDescarga', namespaces=self.ns)[0].text
        xMunDescarga_0 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:xMunDescarga', namespaces=self.ns)[0].text
        chNFe_0_0 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:infNFe/ns:chNFe', namespaces=self.ns)[0].text
        chNFe_0_1 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:infNFe/ns:chNFe', namespaces=self.ns)[1].text

        cMunDescarga_1 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:cMunDescarga', namespaces=self.ns)[1].text
        xMunDescarga_1 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:xMunDescarga', namespaces=self.ns)[1].text
        chNFe_1_0 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:infNFe/ns:chNFe', namespaces=self.ns)[0].text
        chNFe_1_1 = self.xml_assinado.xpath('//ns:infMDFe/ns:infDoc/ns:infMunDescarga/ns:infNFe/ns:chNFe', namespaces=self.ns)[1].text
    ...
    def grupo_produto_predominante(self):
        ...
        xProd = self.xml_assinado.xpath('//ns:infMDFe/ns:prodPred/ns:xProd', namespaces=self.ns)[0].text
        cEAN = self.xml_assinado.xpath('//ns:infMDFe/ns:prodPred/ns:cEAN', namespaces=self.ns)[0].text
    ...
    def grupo_totais(self):
        ...
        vCarga = self.xml_assinado.xpath('//ns:infMDFe/ns:tot/ns:vCarga', namespaces=self.ns)[0].text
    ...
    def grupo_lacres(self):
        nLacre_1 = self.xml_assinado.xpath('//ns:infMDFe/ns:lacres/ns:nLacre', namespaces=self.ns)[0].text
        nLacre_2 = self.xml_assinado.xpath('//ns:infMDFe/ns:lacres/ns:nLacre', namespaces=self.ns)[1].text
        nLacre_3 = self.xml_assinado.xpath('//ns:infMDFe/ns:lacres/ns:nLacre', namespaces=self.ns)[2].text
    ...
    def grupo_qrcode(self):
        qrCodMDFe = self.xml_assinado.xpath('//ns:infMDFeSupl/ns:qrCodMDFe', namespaces=self.ns)[0].text
        # self.assertEqual(qrCodMDFe, '<![CDATA[https://dfe-portal.svrs.rs.gov.br/mdfe/qrCode?chMDFe=51210199999999000199589200000000011399250687&tpAmb=2]]>')
