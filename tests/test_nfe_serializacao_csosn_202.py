...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_csosn202_test(self):
        ...
        # Impostos
        # ICMS
        orig = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:orig', namespaces=self.ns)[0].text
        CSOSN = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:CSOSN', namespaces=self.ns)[0].text
        modBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:modBCST', namespaces=self.ns)[0].text
        pMVAST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:pMVAST', namespaces=self.ns)[0].text
        pRedBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:pRedBCST', namespaces=self.ns)[0].text
        vBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:vBCST', namespaces=self.ns)[0].text
        pICMSST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:pICMSST', namespaces=self.ns)[0].text
        vICMSST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:vICMSST', namespaces=self.ns)[0].text
        vBCFCPST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:vBCFCPST', namespaces=self.ns)[0].text
        pFCPST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:pFCPST', namespaces=self.ns)[0].text
        vFCPST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN202/ns:vFCPST', namespaces=self.ns)[0].text
