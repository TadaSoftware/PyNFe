...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_csosn900_test(self):
        ...
        # Impostos
        # ICMS
        orig = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:orig', namespaces=self.ns)[0].text
        CSOSN = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:CSOSN', namespaces=self.ns)[0].text

        modBC = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:modBC', namespaces=self.ns)[0].text
        vBC = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:vBC', namespaces=self.ns)[0].text
        pRedBC = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:pRedBC', namespaces=self.ns)[0].text
        pICMS = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:pICMS', namespaces=self.ns)[0].text
        vICMS = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:vICMS', namespaces=self.ns)[0].text

        modBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:modBCST', namespaces=self.ns)[0].text
        pMVAST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:pMVAST', namespaces=self.ns)[0].text
        pRedBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:pRedBCST', namespaces=self.ns)[0].text
        vBCST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:vBCST', namespaces=self.ns)[0].text
        pICMSST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:pICMSST', namespaces=self.ns)[0].text
        vICMSST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:vICMSST', namespaces=self.ns)[0].text

        vBCFCPST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:vBCFCPST', namespaces=self.ns)[0].text
        pFCPST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:pFCPST', namespaces=self.ns)[0].text
        vFCPST = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:vFCPST', namespaces=self.ns)[0].text

        pCredSN = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:pCredSN', namespaces=self.ns)[0].text
        vCredICMSSN = self.xml_assinado.xpath('//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN900/ns:vCredICMSSN', namespaces=self.ns)[0].text
