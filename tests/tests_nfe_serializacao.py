...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.notafiscal = self.preenche_notafiscal()
    ...
    def test_dados_destinatario(self):
    ...
    def test_notas_referenciadas(self):
    ...
    def test_responsavel_tecnico(self):
