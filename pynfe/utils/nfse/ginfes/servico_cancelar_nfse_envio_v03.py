...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    "urn:uuid:0b395592-75a5-46a8-bd6b-7734be3db123"
)
...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://www.ginfes.com.br/servico_cancelar_nfse_envio_v03.xsd", create_if_missing=True
)
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_envio_v03.xsd", 12, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __Pedido = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, "Pedido"),
        "Pedido",
        "__httpwww_ginfes_com_brservico_cancelar_nfse_envio_v03_xsd_CTD_ANON_Pedido",
        False,
        pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_envio_v03.xsd",
            14,
            4,
        ),
    )
    ...
    __Signature = pyxb.binding.content.ElementDeclaration(
        ...
        "Signature",
        "__httpwww_ginfes_com_brservico_cancelar_nfse_envio_v03_xsd_CTD_ANON_httpwww_w3_org200009xmldsigSignature",
        False,
        pyxb.utils.utility.Location(
    ...
    _ElementMap.update({__Pedido.name(): __Pedido, __Signature.name(): __Signature})
...
CancelarNfseEnvio = pyxb.binding.basis.element(
    ...
    location=pyxb.utils.utility.Location(
        "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_envio_v03.xsd", 11, 1
    ),
)
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(None, "Pedido"),
        _ImportedBinding__tipos.tcPedidoCancelamento,
        scope=CTD_ANON,
        location=pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_envio_v03.xsd",
            14,
...
def _BuildAutomaton():
    ...
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(None, "Pedido")),
        pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_envio_v03.xsd",
            14,
            4,
