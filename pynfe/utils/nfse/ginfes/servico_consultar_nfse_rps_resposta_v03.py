...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    "urn:uuid:235876ac-3889-4e8d-a9c2-93e46837978b"
)
...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://www.ginfes.com.br/servico_consultar_nfse_rps_resposta_v03.xsd", create_if_missing=True
)
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_consultar_nfse_rps_resposta_v03.xsd",
        6,
        2,
    )
    _ElementMap = {}
    ...
    __CompNfse = pyxb.binding.content.ElementDeclaration(
        ...
        "CompNfse",
        "__httpwww_ginfes_com_brservico_consultar_nfse_rps_resposta_v03_xsd_CTD_ANON_httpwww_ginfes_com_brservico_consultar_nfse_rps_resposta_v03_xsdCompNfse",
        False,
    ...
    __ListaMensagemRetorno = pyxb.binding.content.ElementDeclaration(
        ...
        "__httpwww_ginfes_com_brservico_consultar_nfse_rps_resposta_v03_xsd_CTD_ANON_httpwww_ginfes_com_brtipos_v03_xsdListaMensagemRetorno",
        False,
        pyxb.utils.utility.Location(
    ...
    _ElementMap.update(
        {__CompNfse.name(): __CompNfse, __ListaMensagemRetorno.name(): __ListaMensagemRetorno}
    )
...
def _BuildAutomaton():
    ...
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, "CompNfse")),
        pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_consultar_nfse_rps_resposta_v03.xsd",
            8,
            4,
