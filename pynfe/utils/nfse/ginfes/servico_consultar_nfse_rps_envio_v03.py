...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    "urn:uuid:a4a61edf-1679-4da7-8bba-d795129be900"
)
...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://www.ginfes.com.br/servico_consultar_nfse_rps_envio_v03.xsd", create_if_missing=True
)
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_consultar_nfse_rps_envio_v03.xsd",
        13,
        2,
    )
    _ElementMap = {}
    ...
    __IdentificacaoRps = pyxb.binding.content.ElementDeclaration(
        ...
        "IdentificacaoRps",
        "__httpwww_ginfes_com_brservico_consultar_nfse_rps_envio_v03_xsd_CTD_ANON_httpwww_ginfes_com_brservico_consultar_nfse_rps_envio_v03_xsdIdentificacaoRps",
        False,
    ...
    __Prestador = pyxb.binding.content.ElementDeclaration(
        ...
        "Prestador",
        "__httpwww_ginfes_com_brservico_consultar_nfse_rps_envio_v03_xsd_CTD_ANON_httpwww_ginfes_com_brservico_consultar_nfse_rps_envio_v03_xsdPrestador",
        False,
        pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_consultar_nfse_rps_envio_v03.xsd",
            17,
    ...
    __Signature = pyxb.binding.content.ElementDeclaration(
        ...
        "Signature",
        "__httpwww_ginfes_com_brservico_consultar_nfse_rps_envio_v03_xsd_CTD_ANON_httpwww_w3_org200009xmldsigSignature",
        False,
        pyxb.utils.utility.Location(
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "IdentificacaoRps"),
        _ImportedBinding__tipos.tcIdentificacaoRps,
        scope=CTD_ANON,
        location=pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_consultar_nfse_rps_envio_v03.xsd",
            15,
...
def _BuildAutomaton():
    ...
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, "IdentificacaoRps")),
        pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_consultar_nfse_rps_envio_v03.xsd",
            15,
            4,
