...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    "urn:uuid:50cd1234-0b69-4102-a0d6-2a59b44785d5"
)
...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://www.ginfes.com.br/servico_cancelar_nfse_resposta_v03.xsd", create_if_missing=True
)
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_resposta_v03.xsd",
        6,
        2,
    )
    _ElementMap = {}
    ...
    __Cancelamento = pyxb.binding.content.ElementDeclaration(
        ...
        "Cancelamento",
        "__httpwww_ginfes_com_brservico_cancelar_nfse_resposta_v03_xsd_CTD_ANON_httpwww_ginfes_com_brservico_cancelar_nfse_resposta_v03_xsdCancelamento",
        False,
    ...
    __ListaMensagemRetorno = pyxb.binding.content.ElementDeclaration(
        ...
        "__httpwww_ginfes_com_brservico_cancelar_nfse_resposta_v03_xsd_CTD_ANON_httpwww_ginfes_com_brtipos_v03_xsdListaMensagemRetorno",
        False,
        pyxb.utils.utility.Location(
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "Cancelamento"),
        _ImportedBinding__tipos.tcCancelamentoNfse,
        scope=CTD_ANON,
        location=pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_resposta_v03.xsd",
            8,
...
def _BuildAutomaton():
    ...
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, "Cancelamento")),
        pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_cancelar_nfse_resposta_v03.xsd",
            8,
            4,
