...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    "urn:uuid:39de2bfc-9ae4-40e1-bb37-494b66bc6a8d"
)
...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://www.ginfes.com.br/servico_enviar_lote_rps_envio_v03.xsd", create_if_missing=True
)
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_enviar_lote_rps_envio_v03.xsd", 7, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __LoteRps = pyxb.binding.content.ElementDeclaration(
        ...
        "LoteRps",
        "__httpwww_ginfes_com_brservico_enviar_lote_rps_envio_v03_xsd_CTD_ANON_httpwww_ginfes_com_brservico_enviar_lote_rps_envio_v03_xsdLoteRps",
        False,
        pyxb.utils.utility.Location(
            "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_enviar_lote_rps_envio_v03.xsd",
            9,
            4,
        ),
    )
    ...
    __Signature = pyxb.binding.content.ElementDeclaration(
        ...
        "Signature",
        "__httpwww_ginfes_com_brservico_enviar_lote_rps_envio_v03_xsd_CTD_ANON_httpwww_w3_org200009xmldsigSignature",
        False,
        pyxb.utils.utility.Location(
...
EnviarLoteRpsEnvio = pyxb.binding.basis.element(
    ...
    location=pyxb.utils.utility.Location(
        "/workspaces/PyNFe/pynfe/data/XSDs/NFS-e/Ginfes/servico_enviar_lote_rps_envio_v03.xsd", 6, 1
    ),
)
